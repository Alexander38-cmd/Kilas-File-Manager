...
class JdbcClass {
    static {
        try {
            ...
            Connection connection = DriverManager.getConnection("jdbc:sqlite:server/Authorization.db");
    ...
    private JdbcClass() {
        try {
            this.connection = DriverManager.getConnection("jdbc:sqlite:server/Authorization.db");
